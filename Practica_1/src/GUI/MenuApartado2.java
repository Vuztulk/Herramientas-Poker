...
public class MenuApartado2 extends JPanel {

	private static final long serialVersionUID = 1L;
	private List<String> manos;
	private Controller controller;

	public MenuApartado2(List<String> manos, Controller controller) {
		this.manos = manos;
	...
	private void initialize() {
	    ...
	    List<String> resultados = controller.obtenerManoComunesRaw(manos); 
